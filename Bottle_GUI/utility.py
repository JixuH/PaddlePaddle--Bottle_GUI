...
def parse_args():
    ...
    add_arg('pretrained_model', str,   './models', "The init model path.")
    add_arg('dataset',          str,   'coco2017',  "coco2014, coco2017.")
    add_arg('class_num',        int,   5,          "Class number.")
    ...
    add_arg('draw_threshold',  float, 0.6,    "Confidence threshold to draw bbox.")
    add_arg('image_path',       str,   './img.png',  "The image path used to inference and visualize.")
    # ce
    parser.add_argument(
